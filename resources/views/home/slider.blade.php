        ...
        <div class="carousel-item active" style="background: url('{{asset('assets/img/slide/slide-1.jpg')}}')">
          ...
          <div class="carousel-container">
            <div class="carousel-content">
              <h2 class="animate__animated animate__fadeInDown">{{trans('all.company')}} <span>{{trans('all.site-title')}}</span></h2>
              <p class="animate__animated animate__fadeInUp">{{trans('all.text1')}}</p>
              <a href="" class="btn-get-started animate__animated animate__fadeInUp">{{trans('all.read')}}</a>
            </div>
          </div>
        </div>
